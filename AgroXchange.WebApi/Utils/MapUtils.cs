...
namespace AgroXchange.WebApi.Utils
{
    ...
    public class GeoLocation
    {
        ...
        private static double MIN_LAT = MapUtils.ConvertDegreesToRadians(-90d);  // -PI/2
        private static double MAX_LAT = MapUtils.ConvertDegreesToRadians(90d);   //  PI/2
        private static double MIN_LON = MapUtils.ConvertDegreesToRadians(-180d); // -PI
        private static double MAX_LON = MapUtils.ConvertDegreesToRadians(180d);  //  PI
        ...
        public static GeoLocation FromDegrees(double latitude, double longitude)
        {
            ...
            {
                radLat = MapUtils.ConvertDegreesToRadians(latitude),
                radLon = MapUtils.ConvertDegreesToRadians(longitude),
                degLat = latitude,
                degLon = longitude
            };
            result.CheckBounds();
        ...
        public static GeoLocation FromRadians(double latitude, double longitude)
        {
            GeoLocation result = new GeoLocation
            {
                radLat = latitude,
                radLon = longitude,
                degLat = MapUtils.ConvertRadiansToDegrees(latitude),
                degLon = MapUtils.ConvertRadiansToDegrees(longitude)
            };
            result.CheckBounds();
            return result;
        }
        ...
        /// GeoLocation instance. Must be measured in the same unit as the radius argument.
        /// </param>
